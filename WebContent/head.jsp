	...
	<div class="container-fluid" style="position: relative;">
		...
		<div class="page-header"
				...
				<div class="col-sm-3">
					<div class="dropdown" style="padding: 40px 20px 30px 110px">
						<button class="btn btn-default dropdown-toggle"
							...
							<img src="Images/user.png" style="height: 60px; width: 50px" />
			...
			<ul class="nav nav-tabs" style="margin: 20px">
				...
				<li style="float: right"><a href="contactus.jsp">Contact Us</a></li>
				<li style="float: right"><a href="#">Sell With Us</a></li>
			</ul>
		...
		<div class="modal-dialog">
			<div class="loginmodal-container">
				...
				<div class="login-help">
					<a href="#"><b>Forgot Password? </b></a><a href="signup.jsp" class="btn aon"
